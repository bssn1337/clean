...
systemctl enable anti-backdoor.path 2>/dev/null || true
systemctl start  anti-backdoor.path 2>/dev/null || true
...
REMAINING=$(ps aux 2>/dev/null | grep -E 'defunct|gs-dbus|xmrig|\.config/htop' \
